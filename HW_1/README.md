...
Обновить ядро Ubuntu до mainline-версии (самой свежей стабильной сборки от команды Ubuntu).  
Способ выполнения: основное задание — обновление из mainline-репозитория вручную.

В рамках данного отчёта выполнена ручная установка mainline-ядра версии 6.19.10.
...
Создана отдельная директория `kernel`, в неё скачаны с [официального репозитория mainline-сборок Ubuntu](https://kernel.ubuntu.com/mainline/) (выбрана версия [6.19.10](https://kernel.ubuntu.com/mainline/v6.19.10/)) четыре необходимых пакета:
